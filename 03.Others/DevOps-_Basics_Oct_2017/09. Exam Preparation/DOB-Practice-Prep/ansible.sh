...
echo '192.168.82.100' >> /etc/ansible/hosts

echo '[jenkins]' >> /etc/ansible/hosts
echo '192.168.82.101' >> /etc/ansible/hosts

echo '[nagios]' >> /etc/ansible/hosts
echo '192.168.82.102' >> /etc/ansible/hosts

echo '[docker]' >> /etc/ansible/hosts
echo '192.168.82.103' >> /etc/ansible/hosts
...
mv /tmp/RedHat.yml /playbooks/roles/geerlingguy.java/vars/RedHat.yml
